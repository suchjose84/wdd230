const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=06087b0df1c638d2543f3f92fd17fde4";
...
const apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=06087b0df1c638d2543f3f92fd17fde4";
...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        const town = towns[6];
        console.log(town);
        let eventImages = ["images/11SSgeyser.jpg","images/11SScelebration.jpg", "images/11SSoctoberfest.jpg"];
